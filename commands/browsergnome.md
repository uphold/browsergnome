---
name: browsergnome
description: The autonomous JS web performance engineer. Open the browsergnome menu (Perf Map 3D, Autoresearch first-load, Doctor, Configurations), or pass a natural-language goal.
argument-hint: "<natural-language goal> | scan <path> | map <graph.json> | first-load"
---
